...
export const getAllRadiusCombinations = async () => {
	...
	appendToFile(`jupyter/predictions.csv`, `Real_Magnitude,Radius,Random_Forest_Classifier,Multi_Layer_Perceptron,MLP_With_Scaling,Logistic_Regression,SupportVectorMachines,RandomForests\n`)
